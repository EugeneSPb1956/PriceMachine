...
Ниже показан результат работы функция "calculate_and_display_average_price(data)", которая вычисляет и выводит среднюю цену закрытия акций за заданный период.
